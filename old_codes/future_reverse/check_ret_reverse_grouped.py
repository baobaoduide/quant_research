...
def check_reverse_relation(start_date, end_date):
    ...
    #
    fee_change_data = prepare_fee_data(future_data_fee)
    corr_data_all = find_best_para(fee_change_data, future_data_trade, trade_days)
    return corr_data_all


corr_data_all = check_reverse_relation('2001-01-01', '2021-10-11')
